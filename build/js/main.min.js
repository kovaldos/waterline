...
/*!***********************************************!*\
  ...
  \***********************************************/
/*! exports provided: initFormValidate */function(e,t,n){"use strict";n.r(t),n.d(t,"initFormValidate",(function(){return a}));var i=n(/*! ./form-validate */"./js/modules/form/form-validate.js"),o=document.querySelectorAll("[data-validate]"),r=function(e){setTimeout((function(){window.clearForm(e)}),1e3)},s={base:{validationSuccessCallback:function(e){e.preventDefault(),r(e.target)},validationErrorCallback:function(e){e.preventDefault()}},customExample:{validationSuccessCallback:function(e){e.preventDefault(),r(e.target),console.log("Ваша форма успешна отправлена")},validationErrorCallback:function(e){e.preventDefault(),console.error("Отправка формы невозможна, заполните все обязательные поля")}}},a=function(){o.length&&(document.querySelectorAll('[data-validate-type="phone"] input').length&&document.querySelector("html").addEventListener("input",(function(e){var t=e.target;t.closest('[data-validate-type="phone"]')&&t.closest('[data-validate-type="phone"]').querySelector("input").dispatchEvent(new Event("input"))})),o.forEach((function(e){var t=e.dataset.callback;return t||(t="base"),new i.default(e,s[t]).init()})))}},"./js/modules/genplan-items.js":
/*!*************************************!*\
  !*** ./js/modules/genplan-items.js ***!
  \*************************************/
/*! exports provided: genplanItems */function(e,t,n){"use strict";n.r(t),n.d(t,"genplanItems",(function(){return o}));var i=n(/*! ./modals/init-modals */"./js/modules/modals/init-modals.js"),o=function(){var e=document.querySelector(".genplan");e&&e.querySelectorAll(".genplan__item").forEach((function(e,t){e.setAttribute("data-status",""),e.setAttribute("tabindex","1"),e.setAttribute("data-id",t+1),e.addEventListener("keydown",(function(e){"Enter"===e.key&&i.modals.open("genplan")}))}))}},"./js/modules/modal-slider.js":
/*!************************************!*\
  !*** ./js/modules/modal-slider.js ***!
  \************************************/
/*! exports provided: initModalSlider */function(e,t,n){"use strict";n.r(t),n.d(t,"initModalSlider",(function(){return r}));var i=n(/*! jquery */"../node_modules/jquery/dist/jquery.js"),o=n.n(i);n(/*! slick-carousel */"../node_modules/slick-carousel/slick/slick.js");function r(){o()(".modal--genplan__slider").slick({infinite:!1})}window.jQuery=o.a,window.$=o.a},"./js/modules/modals/init-modals.js":
/*!******************************************!*\
